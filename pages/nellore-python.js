...
export default function PythonNellore() {
  ...
  const comparisonData = [
    {
      feature: "Trainer Interaction",
      bad: "Limited due to large batches",
      good: "Direct & personal interaction",
    },
    {
      feature: "Teaching Approach",
      bad: "Fast-paced, generic flow",
      good: "Student-paced, concept clarity",
    },
    {
      feature: "Doubt Resolution",
      bad: "Fixed or time-bound sessions",
      good: "Continuous doubt clarification support",
    },
    {
      feature: "Language Comfort",
      bad: "Mostly English",
      good: "Telugu + English explanation",
    },
    {
      feature: "Class Mode",
      bad: "Only Online or Only Offline",
      good: "Live Online + Offline",
    },
    {
      feature: "Local Support",
      bad: "No local after-class support",
      good: "On-ground support in Nellore",
    },
  ];
    ...
    <div className="min-h-screen font-sans text-gray-800 bg-slate-50 overflow-x-hidden">
      ...
      <div className="w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden">
        ...
        >
          ...
          {/* Dynamic Month Text */}
          <span>🚨 {getCurrentMonth()} Batch Closing Soon</span>
...
"
              >
                <span className="block">Live Online & Offline</span>

                <span className="block">Python + AI Training</span>
...
mx-auto lg:mx-0 leading-relaxed drop-shadow px-2 md:px-0"
              >
                Same <b className="text-white">"MNC Level"</b> training, now
                near you.
              </p>
    ...
    ${activeForm === "python" ? "translate-x-0" : "translate-x-full"}
    ...
    ${activeForm === "python" ? "text-white" : "text-gray-700"}`}
                  >
                    Python Training
                  </button>
                  ...
                  <button
                    ...
                    className={`relative z-10 w-1/2 py-4 text-lg font-semibold rounded-xl transition-colors duration-300
    ${activeForm === "others" ? "text-white" : "text-gray-700"}`}
                  >
                    Other Courses
                  </button>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
              ...
              <div className="hidden md:block bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div className="grid grid-cols-3 bg-gray-100 border-b border-gray-200 font-bold text-base text-gray-700">
                  ...
                  <div className="p-5 text-center text-gray-500">
                    Metro City Institutes
                  </div>
                  <div className="p-5 text-center text-green-700 bg-green-50">
                    Careerschool
                  </div>
                </div>
                {comparisonData.map((row, idx) => (
                  <div
                    key={idx}
                    className="grid grid-cols-3 border-b border-gray-100 last:border-0 text-base"
                  >
                    <div className="p-4 font-medium text-gray-700 flex items-center justify-center text-center">
                      {row.feature}
                    </div>
                    <div className="p-4 text-red-500 bg-red-50/30 flex items-center justify-center text-center">
                      {row.bad}
                    </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 text-xs">
                      ...
                      <div className="p-3 text-center bg-green-50/50">
                        <span className="block text-green-600/70 text-[10px] uppercase mb-1">
                          Careerschool
                        </span>
            ...
            <div className="text-center lg:text-left max-w-xl mx-auto lg:mx-0 space-y-6 md:space-y-8">
              <h3 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight">
                No.1 Choice for <br />
                <span className="text-blue-600">Python & AI Training</span>{" "}
                <br />
                in Nellore
              </h3>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                Live Online & Offline classes designed to build strong
                fundamentals, real-world skills, and confidence - with personal
                trainer guidance at every step.
              </p>
              ...
              <div>
                <a
                  href="#register"
                  className="inline-block mt-4 md:mt-6 bg-blue-700 text-white px-8 py-3 md:px-10 md:py-3.5 rounded-xl font-bold text-sm md:text-base shadow-lg hover:bg-blue-800 transition"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-24">
            ...
            <p className="text-gray-500 mt-2 md:mt-4 text-sm md:text-lg max-w-2xl mx-auto">
              A structured training module from Python fundamentals to
          ...
          <div className="relative">
            ...
            <RoadmapItem
              ...
              sections={[
                ...
                },
                {
                  ...
                  items: ["Strings", "Lists & Tuples", "Sets & Dictionaries"],
                },
                {
            ...
            <RoadmapItem
              ...
              sections={[
                ...
                },
                {
                  ...
                  items: ["Models", "CRUD Operations", "REST API using Django"],
                },
              ]}
            />
            ...
            <div className="flex justify-center mt-12 md:mt-24">
              <div
                className="bg-green-600 text-white px-6 py-3 md:px-10 md:py-4 rounded-full 
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="leading-relaxed text-gray-400 mb-4 pr-0 md:pr-4">
              We are on a mission to make Nellore students IT-ready by providing
              industry-standard training right in their hometown.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="leading-relaxed">
              Children's Park Road, opposite to Aditya Degree College,
              <br />
              Aditya Nagar, Ramji Nagar,
              <br />
              Nellore, AP 524002.
            </p>
          </div>
  ...
  function RoadmapItem({ step, title, sections, side }) {
    ...
    return (
      <div className="relative mb-8 md:mb-16">
        ...
        <div
          className={`flex w-full ${isLeft ? "md:justify-end" : "md:justify-start"}`}
        >
          {/* THE CARD */}
          <div
            className={`
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 md:gap-4">
                  <div
                    className="bg-blue-600 text-white font-extrabold 
                ...
                <span
                  className={`text-xl md:text-2xl font-bold text-gray-400 transition-transform duration-300 ${open ? "rotate-180" : ""}`}
                >
                  {open ? "−" : "+"}
                </span>
              </div>
            ...
            >
              <div className="min-h-0 space-y-4">
                {sections.map((sec, i) => (
                  <div
                    key={i}
                    className="bg-slate-50 rounded-xl p-3 md:p-4 border border-slate-100"
                  >
